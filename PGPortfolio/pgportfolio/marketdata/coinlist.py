...
class CoinList(object):
            ...
            if k.startswith("BTC_") or k.endswith("_BTC"):
                ...
                for c, val in v.items():
                    if c != 'BTC':
                        ...
                        volumes.append(self.__get_total_volume(pair=k, global_end=end, days=volume_average_days, forward=volume_forward))
    ...
    def __get_total_volume(self, pair, global_end, days, forward):
        ...
        print("Get total volume:", pair, datetime.fromtimestamp(start), DAY, datetime.fromtimestamp(end))
