...
class DataMatrices:
    def __init__(self, start, end, period, batch_size=50, volume_average_days=30, buffer_bias_ratio=0,
        ...
        if market == "poloniex":
            ...
            # print("Shape:", self.__global_data.shape)
        else:
        ...
        """
        print("PROBLEM:", len(self._train_ind))
        print("PROBLEM:", len(self._test_ind))
        print("PERIOD NB:", self._num_periods)
        """
        ...
        print("The start date is:", datetime.fromtimestamp(start))
        print("The end date is:", datetime.fromtimestamp(self.__end))
        """
